...
export const collabText =
  "Combining intelligent automation with advanced security to help teams stay efficient and protected.";
...
export const benefits = [
  {
    ...
    text: "Continuously monitors your network and systems for malicious activity to ensure rapid response and prevention.",
  ...
  {
    id: "1",
    title: "Proactive Security Insights",
    text: "Uses AI to analyze patterns and provide predictive alerts, helping users stay ahead of potential cyber threats.",
  ...
  {
    id: "3",
    title: "Lightning-Fast Defense",
    text: "Instantly identifies and reacts to suspicious behavior, ensuring minimal impact and maximum uptime.",
  ...
  },
  {
    ...
    text: "Scans your system for weak points and recommends fixes to strengthen your cybersecurity posture.",
  ...
  },
  {
    ...
    text: "Our AI learns from new threats every day, constantly improving your defense strategies automatically.",
